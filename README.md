...
There is a .R file that contains the downstrean analysis of the ATAC data using the peak count matrix. You will need to have R (v4.2.2) and the following packages:
* edgeR (v3.40.2)
